...
public class OldMainWindowFrame extends JFrame {

    private static OldMainWindowFrame INSTANCE = null;

    private JPanel marginPanel = new JPanel(new GridBagLayout());
    private GridBagConstraints constraints = new GridBagConstraints();
    private mainWindowJPanel panel = new mainWindowJPanel();

    private OldMainWindowFrame() {
    ...
    public static OldMainWindowFrame getINSTANCE() {
        if (INSTANCE == null) {
            INSTANCE = new OldMainWindowFrame();
        }
        return INSTANCE;
    }
    ...
    public class mainWindowJPanel extends JPanel {
        ...
        private mainWindowJPanel() {
            ...
            newBatchButton.addActionListener((e) -> {PayrollDBController.createNewBatch(); PayrollDBController.setComboBatchItems(payrollBatchesComboBox, false);});
