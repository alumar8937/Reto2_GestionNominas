...
public class SEPADocumentGenerator {
     ...
     */
    public static void createSEPADocument(ArrayList<Payroll> payrolls, String msgId, String creDtTm, int nbOfTxs, double ctrlSum, String initgPtyNm) {
        try {
            ...
            generateXMLFile(doc, "sepa_document.xml");
